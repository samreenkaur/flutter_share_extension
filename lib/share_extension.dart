...
import 'package:flutter_share_extension/video_widget.dart';
import 'dart:async';
  ...
  void initState() {
    ...
    _intentDataStreamSubscription = ReceiveSharingIntent.instance.getMediaStream()
      ...
      setState(() {
        ...
        value.forEach((SharedMediaFile shared)
          {
            if (shared.type == SharedMediaType.text)
            {
              _sharedText = shared.message;
                          ...
                          MaterialPageRoute(
                              builder: (_) =>
                                  MediaEditor(
                                    ...
                                    onImageUpdated: (file) {
                                      _sharedFiles?[index] = SharedMediaFile(path: file.path, type: SharedMediaType.image);
                              ...
                              builder: (_) =>
                                  MediaEditor(
                                    ...
                                    fileType: FileType
                                        .video,
                                    onVideoUpdated: (file) {
                                      _sharedFiles?[index] = SharedMediaFile(path: file.path, type: SharedMediaType.video);
                                      setState(() {
